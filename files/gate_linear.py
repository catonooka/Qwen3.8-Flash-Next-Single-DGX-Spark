...
class GateLinear(ReplicatedLinear):
    ...
    def __init__(
        ...
        # GB10 fork (#54048 port): the plain cuBLAS out_dtype epilogue applies on
        # any CUDA-alike device (no bias, since torch.mm has no bias term). The
        # specialized-kernel gate above excludes family-120 Blackwell (GB10 /
        # DGX Spark), which this tier still covers. See vllm#49921 / #54048.
